...
# Dry Bulk Density data from Axford et al. (2009)
...
ax = axs[0]
ax.plot(
    cf8_dbd02.paleoData_values, cf8_dbd02.depth,
    linewidth=0.75, color='black', zorder=10
)
ax.scatter(
    cf8_dbd02.paleoData_values, cf8_dbd02.depth,
    s=10, color='black', zorder=10
)
ax.hlines(
    y=107, xmin=0, xmax=1.25,
    colors='black', linestyles='--'
)
ax.vlines(
    x=rpo_dbd.paleoData_values[7], ymin=107, ymax=120,
    color='gray'
)
ax.axvspan(

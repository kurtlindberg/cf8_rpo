## Lake CF8 RPO Supplemental Figure 7
# Core CF817-03 bulk geochemistry results stackplot
...
mnfe_ens, mnfe = cf8_fun.getlipd('Lindberg.CF8.20242.lpd',
...
ea_totalc_ens.common_time(time_axis=ea_totalc.ageMedian, bounds_error=False).plot_envelope(ax=ax,
                                                                                           ...
                                                                                           shade_clr='#5e3c99',
                                                                                           plot_legend=False)
ax.plot(ea_totalc.ageMedian, ea_totalc.paleoData_values, linestyle='--', color='black', zorder=100)
ax.set_xlim([12500, 0])
ax.set_ylim([0, 16])
ax.set_xticks([])
...
ea_cn_ens.common_time(time_axis=ea_cn.ageMedian, bounds_error=False).plot_envelope(ax=ax,
                                                                                   ...
                                                                                   shade_clr='#4dac26',
                                                                                   plot_legend=False)
ax.plot(ea_cn.ageMedian, ea_cn.paleoData_values, linestyle='--', color='black', zorder=100)
ax.set_xlim([12500, 0])
ax.set_ylim([8, 16])
ax.set_xticks([])
...
ax = axs[2]
ea_d13c_ens.common_time(time_axis=ea_d13c.ageMedian, bounds_error=False).plot_envelope(ax=ax,
                                                                                       curve_clr='#d7191c',
                                                                                       shade_clr='#d7191c',
                                                                                       plot_legend=False)
ax.plot(ea_d13c.ageMedian, ea_d13c.paleoData_values, linestyle='--', color='black', zorder=100)
ax.set_xlim([12500, 0])
ax.set_ylim([-35, -15])
ax.set_xticks([])
...
ax = axs[3]
mnfe_ens.common_time(time_axis=mnfe.ageMedian, bounds_error=False).plot_envelope(ax=ax,
                                                                                 curve_clr='#993404',
                                                                                 shade_clr='#993404',
                                                                                 plot_legend=False)
...
figures7 = plt.gcf()
# figures7.savefig('cf8rpo_figures7.svg')
